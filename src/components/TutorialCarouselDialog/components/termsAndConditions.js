...
const TermsAndConditions = ({ classes }) => (
  <div>
    <Typography variant="display1">
      <FormattedMessage id="tnc.title" defaultMessage="RunebasePrediction Terms and Conditions" />
    </Typography>
    <Paper className={classes.tncWrapper}>
      <div>
        ...
        <ol>
          <li><FormattedMessage id="tnc.general1" defaultMessage="The Site is operated by the RunebasePrediction Foundation (“RunebasePrediction“). At this stage of the Platform development this Site is entirely for free, and no risking of any PRED or RUNES Tokens is required in order to use it. Therefore, all Events and/or Predictions made via the Site are entirely risk free, however this is subject to change in accordance with the development milestones." /></li>
          <li><FormattedMessage id="tnc.general2" defaultMessage="These terms and conditions (“Terms and Conditions“) govern your (“You“, “Your”, “Player“ or “Participant”) use of the platform provided to You by RunebasePrediction.  These Terms and Conditions should be read carefully by You in their entirety prior to Your use of the Platform and/or Site. Please note that these Terms and Conditions constitute a legally binding agreement between You and the Company." /></li>
        </ol>
      </div>
      <div>
        <Typography variant="title">
        ...
        <ul>
          ...
          <li><FormattedMessage id="tnc.definitions2" defaultMessage="“Platform” shall mean the platform developed by RunebasePrediction allowing for the creation of Events and making Predictions via the Site." /></li>
          ...
          <li><FormattedMessage id="tnc.definitions4" defaultMessage="“Restricted Territories” shall mean any jurisdiction in which creating Events making Predictions and/or the use of the platform is illegal as well as any additional jurisdictions added by RunebasePrediction at its sole and absolute discretion." /></li>
          ...
          <li><FormattedMessage id="tnc.definitions6" defaultMessage="“PRED” shall mean the utility token which is the RunebasePrediction Token (PRED) cryptocurrency." /></li>
          <li><FormattedMessage id="tnc.definitions7" defaultMessage="“We“, “Our“ or “Us” shall mean the RunebasePrediction Foundation, and/or any subsidiaries, affiliates, employees, directors, officers, agents, suppliers, consultants and contractors." /></li>
        </ul>
      </div>
      <div>
        <Typography variant="title">
      ...
      <div>
        ...
        <ol>
          ...
          <li><FormattedMessage id="tnc.awards2" defaultMessage="RunebasePrediction reserves the right to withdraw any promotion, award, prize or special offer at any time. In the event that RunebasePrediction believes You are abusing or attempting to abuse any award or other promotion,  or are likely to benefit through abuse or lack of good faith, then RunebasePrediction may, at its sole and absolute discretion, deny, withhold or withdraw from You any award or promotion and/or rescind any policy with respect to You, either temporarily or permanently." /></li>
          <li><FormattedMessage id="tnc.awards3" defaultMessage="RunebasePrediction reserves the right to prevent players from certain jurisdictions from participating and being eligible for any or all promotions and awards, at its sole and absolute discretion." /></li>
        </ol>
      </div>
      <div>
        <Typography variant="title">
        ...
        <ol>
          <li><FormattedMessage id="tnc.powers1" defaultMessage="RunebasePrediction shall make commercially reasonable efforts to prevent any malfunctioning in the Site’s and Platform’s activity. However, in any event of a technical failure (or any other error, including the creation of an Invalid Event) in the Site’s and/or Platform’s systems for any reason whatsoever, RunebasePrediction will be entitled to cancel any Events and or Predictions, concerning which the malfunctioning has occurred, without being liable to You in any form or manner." /></li>
          <li><FormattedMessage id="tnc.powers2" defaultMessage="RunebasePrediction reserves the right to cancel, terminate, modify or suspend the Site and/or Platform if for any reason, the Site and/or Platform cannot be operated as planned, including, but not limited to, infection by computer virus, bugs, tampering or unauthorized intervention, fraud, technical failures as well as any other causes beyond RunebasePrediction’s control. If any errors result in awarding RUNES or PRED (“tokens”) to You or in an increase in tokens paid to You, You shall not be entitled to these tokens. You agree to immediately inform RunebasePrediction of the error and shall repay any tokens credited to You in error to RunebasePrediction (as directed by RunebasePrediction) or RunebasePrediction may, at its discretion, set off such amount against any tokens owed to You." /></li>
          <li><FormattedMessage id="tnc.powers3" defaultMessage="RunebasePrediction reserves the right to limit, refuse or cancel any Event and/or Prediction made by You, where RunebasePrediction believes that any act of fraud or any other act of bad faith has been taken against RunebasePrediction or any third party, whether by You or by any third party, without being liable to You in any form or manner." /></li>
          <li><FormattedMessage id="tnc.powers4" defaultMessage="RunebasePrediction shall be entitled, at its sole discretion, to amend, modify, or discontinue, from time to time, any of part of the Site and/or Platform, and/or awards and/or promotions and/or introduce new features of the Site and/or Platform and/or new awards and/or promotions. We shall not be liable for any loss suffered by You resulting from any changes made and You shall have no claims against Us in such regard." /></li>
        </ol>
      </div>
      <div>
        <Typography variant="title">
        ...
        <ol>
          ...
          <li><FormattedMessage id="tnc.responsibilities9" defaultMessage="You are responsible for maintaining your own wallet. RunebasePrediction is a decentralized application, with no centralized mechanism for accessing your wallet. RunebasePrediction does not keep, store, save, or in any way backup your account details. Therefore RunebasePrediction is unable to assist in any way to recover wallet access. Mismanagement of your wallet details may cause you to lose all your funds that may not be recoverable. We are not responsible for the loss of such funds arising from entering the wrong wallet details." /></li>
        </ol>
      </div>
      <div>
        <Typography variant="title">
      ...
      <div>
        ...
        <ol>
          <li><FormattedMessage id="tnc.support1" defaultMessage="You may contact the Company in connection with anything related to the Site and/or Platform at any time via our customer support, which is available at support@runebaseprediction.network." /></li>
      ...
      <div>
        ...
        <ol>
          <li><FormattedMessage id="tnc.misc1" defaultMessage="These Terms and Conditions and the relationship between You and Us shall be governed by, and construed and interpreted in accordance with, the laws of Belgium, and You irrevocably submit to the exclusive jurisdiction of the competent courts of Belgium with respect to any dispute regarding the validity, breach, interpretation, performance or otherwise arising out of or in connection with these Terms and Conditions and the relationship between You and Us." /></li>
          <li><FormattedMessage id="tnc.misc2" defaultMessage="RunebasePrediction may transfer or assign any and all of its rights and obligations hereunder to any third party; without derogating from the above, the Site and/or Platform may be operated by third parties. You may not transfer, assign or pledge in any manner whatsoever any of Your rights or obligations under these Terms and Conditions." /></li>
