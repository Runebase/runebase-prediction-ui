...
const messages = defineMessages({
  resetApprove: {
    ...
    defaultMessage: 'You are trying to use more PRED than your currently approved amount. This will require you to reset the approved amount to 0 first before you can increase it. Or you can change the amount up to the current approved amount.',
  },
  approveNotice: {
    id: 'txConfirm.approveNotice',
    defaultMessage: 'The {action} action requires you to approve PRED to be transferred first. You will be required to confirm the follow-up {action} transaction after this transaction is successful.',
  },
});
  ...
  <ResponsiveTable className={classes.txFeesTable}>
    <TableHead>
      <TableRow>
        ...
        <TableCell><FormattedMessage id="str.fee" defaultMessage="Gas Fee (RUNEBASE)" /></TableCell>
      </TableRow>
    </TableHead>
    <TableBody>
    ...
    <div className={classes.explanationMsgContainer}>
      <Typography variant="body2">
        <FormattedMessage
          ...
          defaultMessage='You are about to {txAction} with a maximum transaction fee of {txFee} RUNEBASE.'
