...
runebasepredictionTheme.typography = {
  ...runebasepredictionTheme.typography,
  ...
  subtitle1: {
    ...
    marginLeft: '0',
    color: textColorDarkGrey,
    [runebasepredictionTheme.breakpoints.down('xs')]: {
      fontSize: smallText,
      fontWeight: fontWeightBold,
...
runebasepredictionTheme.overrides = {
  ...runebasepredictionTheme.overrides,
  MuiButton: {
    root: {
      fontSize: xSmallText,
  ...
  MuiTableCell: {
    body: {
      ...
      [runebasepredictionTheme.breakpoints.down('md')]: {
        padding: px(spaceX),
      },
    },
    head: {
