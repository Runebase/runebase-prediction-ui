...
export default class UiStore {
  @observable location = Routes.RUNEBASE_PREDICTION
  @observable locale = localStorage.getItem('runebaseprediction_dapp_lang') || this.defaultLocale
  ...
  constructor(app) {
    ...
    reaction( // whenever the locale changes, update locale in local storage and moment
      ...
      () => {
        ...
        localStorage.setItem('runebaseprediction_dapp_lang', this.locale);
      },
