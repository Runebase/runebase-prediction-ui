...
import { gasToRunebase, satoshiToDecimal, decimalToSatoshi } from '../../helpers/utility';
...
export default class Transaction {
  ...
  token = '' // Token type used for Transaction. RUNEBASE for BET. PRED for VOTE.
  ...
  constructor(transaction) {
    ...
    this.amount = this.token === Token.PRED ? satoshiToDecimal(this.amount).toString() : this.amount;
