...
const HOSTNAME_MAINNET = 'pred.runebase.io';
const HOSTNAME_TESTNET = 'testpred.runebase.io';
const HOSTNAME_REGTEST = 'regpred.runebase.io';
...
export default {
  ...
  api: {
    ...
    predBalance: `${HTTP_ROUTE}/pred-balance`,
  ...
  explorer: {
    tx: process.env.LOCAL_WALLET === 'true' ? 'https://runebasehost/tx' : `${BASE_RUNEBASE_WEB}/tx`,
  },
};
