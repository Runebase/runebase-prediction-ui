    ...
    return (
      <div className={classes.colDiv}>
        <Typography variant="h4">
          <div className={classes.rowDiv}>
            +{runebaseWinnings} <div className={classes.tokenDiv}>RUNEBASE</div>
            <Tooltip classes={{ tooltip: classes.rewardTooltip }} id="tooltip-reward" title={<RewardTooltipContent token="RUNEBASE" {...props} />}>
