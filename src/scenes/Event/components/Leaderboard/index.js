...
const messages = defineMessages({
  mostRUNEBASE: {
    id: 'leaderboard.mostRUNEBASE',
    defaultMessage: 'Who bet the most RUNEBASE',
  },
  mostPRED: {
    id: 'leaderboard.mostPRED',
    defaultMessage: 'Who bet the most PRED',
  },
  biggestWinner: {
...
const tabs = [messages.mostRUNEBASE, messages.mostPRED, messages.biggestWinner];
                ...
                {leaderboardVotes.map((row, index) =>
                  (
                    <CustomTableRow key={index} className={classes.entry}>
                      ...
                      {!row.amount.runebase && <CustomTableBodyCell>{satoshiToDecimal(row.amount)}</CustomTableBodyCell>}
                      {row.amount.runebase && <CustomTableBodyCell>{satoshiToDecimal(row.amount.runebase)} RUNEBASE,{satoshiToDecimal(row.amount.pred)} PRED</CustomTableBodyCell>}
                    </CustomTableRow>
                  ))}
              </TableBody>
            </Table>
