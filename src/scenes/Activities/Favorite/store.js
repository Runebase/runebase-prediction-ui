...
export default class FavoriteStore {
  @observable favList = JSON.parse(localStorage.getItem('runebaseprediction_dapp_favList')) || []; // Data example: ['21e389b909c7ab977088c8d43802d459b0eb521a', ...]
  ...
  updateLocalStorageFavList() {
    localStorage.setItem('runebaseprediction_dapp_favList', JSON.stringify(this.favList));
  }
  ...
  fetchFav = async () => {
    ...
    // Combine predh WITHDRAW topics and latest phase oracles into result
