...
class CandleStickChartWithMACDIndicator extends PureComponent {
  render() {
...
CandleStickChartWithMACDIndicator.defaultProps = {
  type: 'svg', // eslint-disable-line
};

CandleStickChartWithMACDIndicator = fitWidth(CandleStickChartWithMACDIndicator); // eslint-disable-line
