...
@inject('store')
@observer
export default class RunebasePrediction extends Component {
  ...
  componentDidMount() {
    this.props.store.runebasePrediction.init();
    const interval = 1;
  ...
  render() {
    const { list, loadMore, loadingMore, loading } = this.props.store.runebasePrediction;
